@include('web.header');
  ...
  style="background: url('<?php echo url('web/assets/images/plasma.jpg')?>') no-repeat center; background-size: cover">

    <div class="container zoomIn animated">
      
      <h1 class="page-title">Login To Manage<span class="title-under"></span></h1>
